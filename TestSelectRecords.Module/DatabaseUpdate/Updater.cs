...
namespace TestSelectRecords.Module.DatabaseUpdate;
...
public class Updater : ModuleUpdater
{
    ...
    public override void UpdateDatabaseAfterUpdateSchema()
    {
        ...
        NewUser(defaultRole, userManager, "Janek");
        NewUser(defaultRole, userManager, "Wojtek");
        NewUser(defaultRole, userManager, "Wacek");
        NewUser(defaultRole, userManager, "Jurek");
        NewUser(defaultRole, userManager, "Janusz");
    ...
    private void NewUser(PermissionPolicyRole defaultRole, UserManager userManager, string user)
    {
        if (userManager.FindUserByName<ApplicationUser>(ObjectSpace, user) == null)
        {
            // Set a password if the standard authentication type is used
